...
from algorithm.fitness.lib.linear_regions import get_linear_regions
from algorithm.fitness.lib.ntk import get_ntk_n, get_ntk_score
...
def get_networks(n):
    ...
    for i in range(n):
        particle = Particle(min_layer=3, max_layer=20, max_pool_layers=m_pool, input_width=28, input_height=28,
                            ...
                            max_out_ch=256, max_fc_neurons=300, output_dim=10, device='cuda')
...
ntk = get_ntk_score(dataloader, networks[0], 1)
print(ntk)
